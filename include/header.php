...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i"
        rel="stylesheet" />
    <link href="StyleSheet/StyleSheet4dbf4dbf.css?v=00ddd1" rel="stylesheet" />
...
//]]>
    ...
    <div id="msgurgent">
        <div class="browsermsg">
            <p>
                You are using an outdated browser, some site features may not function as expected.
                Update your browser for the best viewing experience.</p>
            <ul>
        ...
        <div class="icos">
            <div class="icons-in">
                <ul>
                    ...
                    <li><a class="soc_iconh soc_icon4 " href="#" title="Mail Us"></a>
                    </li>
                </ul>
            </div>
        </div>